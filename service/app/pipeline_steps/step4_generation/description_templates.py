...
FEATURE_NAME_FALLBACKS: dict[str, str] = {
    "texture": "Текстура поверхности",
    "lobulation": "Лобуляция",
    "pigmentation": "Пигментация",
    "texture_coarseness": "Грубость текстуры",
    "area": "Площадь",
    "convexity": "Выпуклость контура",
    "solidity": "Плотность формы",
    "extent": "Заполнение ограничивающей области",
    "radial_variance": "Радиальная вариабельность",
    "perimeter_area_ratio": "Отношение периметра к площади",
}
...
def parse_feature_entries(important_features: list[str]) -> Dict[str, list[tuple[str, str]]]:
    ...
    for entry in important_features:
        ...
        rus_name = FEATURE_NAME_FALLBACKS.get(feature_key, feature_key)
