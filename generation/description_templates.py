...
SYSTEM_PROMPT = (
    ...
    "5. Если предоставлена КЛАССИФИКАЦИЯ — она задаёт общий контекст описания: упомяни структурный тип и свойства в тексте, но НЕ ставь диагноз.\n"
    "6. ЗАПРЕЩЕНО: ставить диагноз, предполагать диагноз, упоминать названия заболеваний, давать рекомендации, добавлять комментарии или преамбулы.\n"
